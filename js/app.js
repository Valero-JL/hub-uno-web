...
const els = {
  ...
  humanSeat: document.getElementById('human-seat'),
  humanSeatBack: document.getElementById('human-seat-back'),
  humanSeatCount: document.getElementById('human-seat-count'),
  humanSeatName: document.getElementById('human-seat-name'),
